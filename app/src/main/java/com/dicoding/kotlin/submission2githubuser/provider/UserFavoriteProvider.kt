package com.dicoding.kotlin.submission2githubuser.provider
...
import com.dicoding.kotlin.submission2githubuser.db.UserFavoriteContract.AUTHORITY
...
import com.dicoding.kotlin.submission2githubuser.db.UserFavoriteHelper
...
class UserFavoriteProvider : ContentProvider() {
    ...
    companion object{
        ...
        private lateinit var userFavHelper : UserFavoriteHelper
    ...
    override fun onCreate(): Boolean {
        userFavHelper = UserFavoriteHelper.getInstance(context as Context)
        userFavHelper.open()
        return true
    }
    ...
    override fun query(
        ...
        when (sUriMatcher.match(uri)) {
            USER -> cursor = userFavHelper.queryALl()
            USER_ID -> cursor = userFavHelper.queryById(uri.lastPathSegment.toString())
            else -> cursor = null
        }
